...
Page are created and routed using `@tanstack/react-router`, routes are defined within `@routes`, using Directory Routing, as stated below:
...
**For naming convention, follow tanstack router docs below:**
