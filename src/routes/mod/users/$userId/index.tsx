...
import { usersData } from '@/mock-data/mod-users-detail'
...
export const Route = createFileRoute('/mod/users/$userId/')({
  component: RouteComponent,
})

function RouteComponent() {
  const { userId } = useParams({ from: '/mod/users/$userId/' })
    ...
    return (
      <div className="p-6">
        <div className="text-center">
          ...
          <Button onClick={() => navigate({ to: '/mod/users' })} className='mt-4'>
  ...
  return (
    <div className="p-6 space-y-6 w-full">
      ...
      <div className="flex items-center justify-between">
        <Button variant="outline" onClick={() => navigate({ to: "/mod/users" })}>
          <ArrowLeft className="w-4 h-4 mr-2" />
          Back to Users
        </Button>
