...
export const usersData = {
  ...
  '3': {
    ...
    status: 'Active',
    joinDate: '2023-06-10',
    lastLogin: '2024-11-21 11:45',
    avatar: '/placeholder-avatar.jpg',
    bio: 'Community moderator focused on maintaining quality learning environment.',
    location: 'London, UK',
    coursesReviewed: 45,
    approvalRate: 84.4,
    specialization: 'Programming',
    enrolledCourses: [
      { id: 'C010', title: 'Advanced AI Ethics', progress: 90, enrolledDate: '2024-11-01', status: 'In Progress' },
      { id: 'C011', title: 'Platform Moderation', progress: 100, enrolledDate: '2024-08-15', status: 'Completed' },
    ],
    coursesBeingModerated: [
      { id: 'C001', title: 'React Masterclass', instructor: 'Jane Smith', status: 'Under Review', submittedDate: '2024-11-20', priority: 'high' },
      { id: 'C002', title: 'JavaScript Fundamentals', instructor: 'John Doe', status: 'Published', submittedDate: '2024-10-15', priority: 'medium' },
      { id: 'C003', title: 'Python for Data Science', instructor: 'Alice Brown', status: 'Rejected', submittedDate: '2024-09-20', priority: 'low' },
    ],
    recentActivity: [
      { id: 1, action: 'Approved course', details: 'Data Science with Python', time: '2 hours ago', type: 'approval' },
      { id: 2, action: 'Rejected course', details: 'Quick Coding Course (plagiarism)', time: '1 day ago', type: 'rejection' },
      { id: 3, action: 'Resolved report', details: 'Inappropriate content in discussion', time: '2 days ago', type: 'moderation' },
      { id: 4, action: 'Suspended user', details: 'Violation of community guidelines', time: '1 week ago', type: 'moderation' },
    ]
  },
  '4': {
    id: '4',
